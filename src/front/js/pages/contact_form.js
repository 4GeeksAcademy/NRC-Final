        ...
        <div className={styles.formulario_contacto}>
            ...
            <form onSubmit={handleSubmit} className="needs-validation" noValidate>
                ...
                <div className={styles.commentContact}>
                    ...
                    <textarea type="text" name="comment" value={comment} onChange={handleChangeComment} className={`${styles.formInputComment}`} rows="4" id="commentId" placeholder="Tu mensaje" required/>
                 </div>
